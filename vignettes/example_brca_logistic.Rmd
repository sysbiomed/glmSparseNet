...
# keep metastatic samples (code 11)
...
small.subset <- c(gene.names(c('ENSG00000110448', 'ENSG00000124449', 'ENSG00000103494', 
...
xdata <- xdata.raw[, small.subset[small.subset %in% colnames(xdata)]]
ydata <- class.v
```
