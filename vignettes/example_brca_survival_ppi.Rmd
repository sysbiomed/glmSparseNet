...
```{r, echo=FALSE}
glmSparseNet::separate2groups.cox(as.vector(coef(cv.hub, s = 'lambda.min')[,1]), xdata, ydata,
...
```{r, echo=FALSE}
glmSparseNet::separate2groups.cox(as.vector(coef(cv.orphan, s = 'lambda.min')[,1]), xdata, ydata,
                                  plot.title = 'Full dataset', legend.outside = FALSE)
...
```{r, echo=FALSE}
glmSparseNet::separate2groups.cox(as.vector(coef(cv.glm, s = 'lambda.min')[,1]), xdata, ydata, 
                                  plot.title = 'Full dataset', legend.outside = FALSE)
