...
small.subset <- c(geneNames(c('ENSG00000109790', 'ENSG00000109133', 
                              'ENSG00000023734', 'ENSG00000183770', 
                              'ENSG00000214617', 'ENSG00000185813', 
...
```{r fit}
fitted <- cv.glmHub(xdata, Surv(ydata$time, ydata$status), family  = 'cox', 
                    network = 'correlation', 
