...
ensembl <- verissimo::run.cache(useDataset, "hsapiens_gene_ensembl",mart=ensembl,
                               cache.prefix = 'ensembl',
                               base.dir = '../../network.cox-cache')   # from ensembl using homosapien gene data
