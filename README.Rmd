...
### Survival curves with `separate2groups.cox`
...
```{r call.kaplan}
separate2groups.cox(best.model.coef, t(assay(xdata[['RNASeq2GeneNorm']])), ydata.km, ylim = c(0,1))
```
...
separate2groups.cox(best.model.coef.g, 
